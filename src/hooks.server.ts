...
const addPreloadLinkHeaders = (linkHeader = '', url: string) => {
	linkHeader = `</mutual-funds/fonts/Barlow-Regular.woff2>;rel="preload";as="font";type="font/woff";nopush;crossorigin,</mutual-funds/fonts/Barlow-SemiBold.woff2>;rel="preload";as="font";type="font/woff";nopush;crossorigin,</mutual-funds/fonts/Barlow-Medium.woff2>;rel="preload";as="font";type="font/woff";nopush;crossorigin,${linkHeader}`;
