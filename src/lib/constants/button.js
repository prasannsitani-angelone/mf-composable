export const BUTTON_STYLE = new Map([
	...
	[
		...
		new Map([
			[
				'primary',
				'bg-background-alt hover:bg-background-alt !border border-primary hover:border-primary text-primary'
			],
			[
				'secondary',
				'bg-background-alt hover:bg-background-alt !border border-border hover:border-border text-border'
			],
