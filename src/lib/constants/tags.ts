import type { Tags } from '../types/ITags';
...
export const allDurationTags: Tags[] = [
	{
		label: '1M',
		months: 1,
		timeScale: 'month',
	...
	},
	{
		...
		months: 24,
		timeScale: 'year',
		returnPeriod: 'returns2yr',
		bmReturnPeriod: 'bmReturns2yr',
		text: '2 Years'
	},
	{
		label: '3Y',
	...
	},
	{
		...
		months: 120,
		timeScale: 'year',
		returnPeriod: 'returns10yr',
		bmReturnPeriod: 'bmReturns10yr',
		text: '10 Years'
	},
	{
		label: 'ALL',
