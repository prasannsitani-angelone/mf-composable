...
<InfoModal
	...
	headingClass="!font-medium !text-lg !text-title md:px-4 md:pb-3"
...
>
	<svelte:fragment slot="heading">
		<div class="flex items-center justify-start px-4 pb-3 pt-6 md:px-4 md:pt-6">
			<slot name="headingDetails">
				<span class="text-lg font-medium text-title md:text-lg"> Family Portfolio </span>
			</slot>
		</div>
	</svelte:fragment>
	...
	<svelte:fragment slot="bodySection">
		<section class="px-4 pb-6 pt-0 text-sm md:px-4 md:pt-0">
			<article>
				<p class="text-left font-normal text-body">
