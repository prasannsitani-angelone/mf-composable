...
<article class="bgGradient relative overflow-hidden rounded-lg p-4 text-body md:pl-6 md:pr-9">
	<div
	...
	<section class="flex items-start justify-between">
		<div class="w-[70%]">
			...
			<div class="mt-2">
				You are in the <span class="font-medium text-sell">bottom {calculatedScorePercentage}</span>
