...
<section
	class="cardHeight mt-2 flex flex-col items-center justify-center rounded-lg bg-background-alt px-8 py-4 shadow-csm {$$props?.class}"
>
	<WMSIcon name="red-exclamation" />
	<div class="mt-2 text-center text-sm font-normal text-body">Something Went Wrong</div>
	<div class="text-center text-sm font-normal text-body">Please try again in some time</div>
	<Button
