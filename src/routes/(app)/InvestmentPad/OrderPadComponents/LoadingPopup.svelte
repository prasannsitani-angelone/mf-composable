...
<Modal isModalOpen>
	<div
		class="flex h-full w-full flex-col items-center justify-between overflow-y-auto rounded-none bg-white px-12 py-16 shadow-clg sm:h-max sm:w-120 sm:rounded-lg sm:px-12 sm:py-20"
	>
