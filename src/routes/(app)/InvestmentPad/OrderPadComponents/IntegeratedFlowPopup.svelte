...
<Modal isModalOpen on:backdropclicked={onClose}>
	<div
		class="flex w-full flex-col items-center overflow-y-auto rounded-none rounded-t-2xl bg-background-alt p-4 pt-8 shadow-clg sm:w-120 sm:rounded-lg"
	>
		<div class="text-2xl font-medium text-title">Start Your SIP with Autopay</div>
		<UpiMandateIcon class="mt-4 h-[195px] w-[258px]" />
		<div class="mt-4 flex flex-col gap-4">
			<div class="flex flex-row">
				<div class="mr-1.5 mt-1 h-2 w-2 min-w-[8px] rounded-full bg-title" />
			...
			<div class="flex flex-row">
				<div class="mr-1.5 mt-1 h-2 w-2 min-w-[8px] rounded-full bg-title" />
				<div class="text-sm font-normal text-title">The autopay limit is ₹15,000</div>
			</div>
			<div class="flex flex-row">
				<div class="mr-1.5 mt-1 h-2 w-2 min-w-[8px] rounded-full bg-title" />
				<div class="text-sm font-normal text-title">
			...
			<div class="flex flex-row">
				<div class="mr-1.5 mt-1 h-2 w-2 min-w-[8px] rounded-full bg-title" />
				<div class="text-sm font-normal text-title">You can cancel your SIP any time</div>
			</div>
		</div>
