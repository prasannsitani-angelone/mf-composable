...
<SEO
	seoTitle="This Cart is empty | Angelone"
	seoDescription="No Cart Items Found. This Cart is empty "
/>
...
<ErrorPage
	...
	class=" !h-[calc(100vh-122px)] !justify-center !p-8 max-sm:-mt-4 max-sm:-mb-8 max-sm:rounded-none sm:h-[calc(100vh-260px)]"
>
	<div slot="icon">
