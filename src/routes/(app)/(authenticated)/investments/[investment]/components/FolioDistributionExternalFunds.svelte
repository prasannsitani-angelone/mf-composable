<script lang="ts">
	import type { DistributorListEntity } from '$lib/types/IInvestments';
	export let distributorList: DistributorListEntity[];
</script>

<section class="border-t p-4 md:px-6 md:py-5">
	<ul>
