...
<section
	class="relative -mt-2 mb-2 rounded-lg bg-gradient-to-r from-blue-gradient via-blue-gradient to-blue-primary pb-3 pt-6 text-white md:mt-0 lg:p-6 {$$props.class} {os?.toLowerCase() ===
